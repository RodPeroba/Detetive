...
public class Detetive_panel extends JPanel { // MyDrawImagePanel
	...
	public static JPanel character_panel() { // TODO add botao iniciar partida
		flag_drawimg = 1;
		...
		cb0.setBounds(890, 200, 120, 50);
		cb1.setBounds(890, 250, 120, 50);
		cb2.setBounds(890, 300, 120, 50);
		cb3.setBounds(890, 350, 120, 50);
		cb4.setBounds(890, 400, 120, 50);
		cb5.setBounds(890, 450, 120, 50);
	...
	public void paintComponent(Graphics g) {
		...
		case 1: // character selection
			...
			int panel_size_x = 1200;
			int panel_size_y = 700;
			
			int character_size_x = 145;
			int character_size_y = 225;
			
			int first_character_coord_x = (panel_size_x / 5) - (character_size_x / 2);
			int first_character_coord_y = (panel_size_y / 3) - (character_size_y / 2);
			...
			try {
				...
				g2D.drawImage(characters[0], first_character_coord_x,
											 first_character_coord_y,
											 character_size_x, character_size_y, null);
				
				g2D.drawImage(characters[1], first_character_coord_x + (panel_size_x / 5),
											 first_character_coord_y,
											 character_size_x, character_size_y, null);
				
				g2D.drawImage(characters[2], first_character_coord_x + (2 * panel_size_x / 5),
											 first_character_coord_y,
											 character_size_x, character_size_y, null);
				
				g2D.drawImage(characters[3], first_character_coord_x,
											 first_character_coord_y + (panel_size_y / 3),
											 character_size_x, character_size_y, null);
				
				g2D.drawImage(characters[4], first_character_coord_x + (panel_size_x / 5),
											 first_character_coord_y + (panel_size_y / 3),
											 character_size_x, character_size_y, null);
				
				g2D.drawImage(characters[5], first_character_coord_x + (2 * panel_size_x / 5),
										 	 first_character_coord_y + (panel_size_y / 3),
										 	 character_size_x, character_size_y, null);
			}
			catch(IOException e) {
